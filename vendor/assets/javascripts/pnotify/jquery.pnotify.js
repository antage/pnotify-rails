	...
	var history_handle_top,
		...
		styling = {
			...
			bootstrap: {
				container: "alert",
				notice: "",
				notice_icon: "icon icon-exclamation-sign",
				info: "alert-info",
				info_icon: "icon icon-info-sign",
				success: "alert-success",
				success_icon: "icon icon-ok-sign",
				error: "alert-error",
				error_icon: "icon icon-warning-sign",
